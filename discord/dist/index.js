        ...
        if (message.content === '!ping') {
            ...
            try {
                const res = await axios
                    ...
                    const newRoles = roleSelector_1.roleSelector(message, pilotRating, rating);
                    ...
                    message.reply(replyMessage)
                        ...
                        if ((await utils_1.retrieveUser(message.member)).isNewUser) {
                            ...
                            utils_1.updateUser(message.member, response.data, 'clearNewUser');
                        }
                        else {
                            utils_1.updateUser(message.member, response.data, 'updateUser');
                        }
